...
public class MemberVO {
	...
	public void setMemberEmail(String memberEmai) {
		this.memberEmail = memberEmai;
	}
	...
	public void setMemberGender(String string) {
		this.memberGender = MemberGender.getEnum(string);
	}
	...
	public String toString() {
		return "MemberVO [id=" + id + ", memberEmai=" + memberEmail + ", memberPassword=" + memberPassword
